...
const Pricing = () => {
  ...
  return (
    <MaxWidthWrapper className='mb-8 mt-16 text-center'>
      <div className='mx-auto mb-10 py-24 sm:max-w-lg'>
      ...
      <div className='relative mx-auto mb-14 flex max-w-fit items-center space-x-2'>
        ...
        <span className='absolute -right-12 -top-8 rounded-full bg-purple-200 px-3 py-1 text-sm text-purple-700 sm:-right-[9.5rem] sm:-top-5'>
          🎁 2 months FREE
        </span>
      </div>
