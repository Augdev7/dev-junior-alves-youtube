...
const works = [
  ...
  {
    id: 2,
    img: '/works/logo-ultronia.webp',
    title: 'Ultronia',
    subTitle: 'Desenvolvedor Front-end',
    office: 'Freelancer',
    description:
      'Na Ultronia, atuo como Desenvolvedor Front-End, sendo responsável pelo desenvolvimento e manutenção de aplicações utilizando ReactJS, JavaScript e Material UI. Trabalho em colaboração com a equipe de desenvolvimento back-end, para integrar componentes front-end e back-end de nossas aplicações.',
    tags: [
      { name: 'Html', icon: '/skills/html.svg' },
      { name: 'Css', icon: '/skills/css.svg' },
      { name: 'JavaScript', icon: '/skills/javascript.svg' },
